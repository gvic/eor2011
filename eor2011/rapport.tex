...
le changement de la valeur de son verrou, il faut réalisé la requête
...
Mais ceci sans accès concurrents. Après le codage 'simple' du service, sans
...
Cette application a été très utile puisqu'en lancant celle-ci sur 3 ou plus
