...
Sachant que l'objet \textit{SharedObject} doit étre synchronisé durant
...
fonctionnalitées suivantes gréce à une interface graphique:
\begin{itemize}
...
Bien que nous ayont réfléchis ensemble sur les deux derniéres parties, nous
