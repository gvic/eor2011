...
\subsection{IRC}
L'application \textit{IRC} fournie, a permis de verifier les bases du services.
...
L'application de stress utilisé est simple. Un seul objet partagé au sein du
...
choisi un entier comme objet partagé. Sur lequel nous effectuerons des incrémentation ou
des remise à zero.
Nous avons donc implanter \textit{ClientSimple} qui regroupe les
fonctionnalitées suivantes grace a une interface graphique:
\begin{itemize}
